...
int main() {
	...
	glm::mat4 Projection = glm::perspective(120.0f, 4.0f / 3.0f, 0.0f, 100.0f);
	// Or, for an ortho camera :
	//glm::mat4 Projection = glm::ortho(-1.0f, 50.0f, -1.0f,50.0f,0.0f,100.0f); // In world coordinates

	// Camera matrix
	glm::mat4 View       = glm::lookAt(
			glm::vec3(22500, 16700, 10000), // Camera is at (4,3,3), in World Space
			glm::vec3(22500, 16700, 0), // and looks at the origin
